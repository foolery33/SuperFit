...
final class GarbageManager {
    ...
    static var shared: GarbageManager = {
        ...
        let lastExercisesRepository = LastExercisesRepositoryImplementation(getTrainingTypeModelByTrainingNameUseCase: GetTrainingTypeModelByTrainingNameUseCase())
    ...
    init(userDataManager: UserDataManagerRepository, profilePhotosRepository: ProfilePhotosRepository, lastExercisesRepository: LastExercisesRepository, userBodyParametersRepository: UserBodyParametersRepository) {
