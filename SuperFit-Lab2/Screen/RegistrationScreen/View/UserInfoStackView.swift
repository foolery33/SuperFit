...
class UserInfoStackView: UIStackView {
    ...
    private lazy var userNameField: UnderlinedTextField = {
        let myTextField = UnderlinedTextField(currentText: self.userNameText, placeholderText: R.string.registerScreenStrings.username(), isSecured: false)
    ...
    private lazy var emailField: UnderlinedTextField = {
        let myTextField = UnderlinedTextField(currentText: self.emailText, placeholderText: R.string.registerScreenStrings.email(), isSecured: false)
    ...
    private lazy var codeField: UnderlinedTextField = {
        let myTextField = UnderlinedTextField(currentText: self.codeText, placeholderText: R.string.registerScreenStrings.code(), isSecured: true)
    ...
    private lazy var repeatCodeField: UnderlinedTextField = {
        let myTextField = UnderlinedTextField(currentText: self.repeatCodeText, placeholderText: R.string.registerScreenStrings.repeat_code(), isSecured: true)
