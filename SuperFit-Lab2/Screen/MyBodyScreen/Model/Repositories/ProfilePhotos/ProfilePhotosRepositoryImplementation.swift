...
final class ProfilePhotosRepositoryImplementation: ProfilePhotosRepository {
    ...
    func loadBeforePhotoWithDate() -> (UIImage?, String?) {
        return (KingfisherManager.shared.cache.retrieveImageInMemoryCache(forKey: CodingKeys.beforePhoto), UserDefaults.standard.string(forKey: CodingKeys.beforePhotoDate))
    }
    ...
    func loadAfterPhotoWithDate() -> (UIImage?, String?) {
        return (KingfisherManager.shared.cache.retrieveImageInMemoryCache(forKey: CodingKeys.afterPhoto), UserDefaults.standard.string(forKey: CodingKeys.afterPhotoDate))
    }
